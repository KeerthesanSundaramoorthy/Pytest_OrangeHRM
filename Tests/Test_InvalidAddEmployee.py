...
@pytest.mark.parametrize("fname,mname,lname,emp_id", Excel_Reader.get_data("E:\gitpytest_clone\Pytest_OrangeHRM\ExcelFiles\Invalid_Add_Employee.xlsx", "InvalidAddEmployee"))
