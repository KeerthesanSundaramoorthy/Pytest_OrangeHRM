...
@pytest.mark.parametrize("username,password",ExcelReader.get_data("E:\Pytest_clone\Pytest_clone\Pytest_OrangeHRM\ExcelFiles\Invalid_LoginData.xlsx","loginInvalid"))
class TestLogin:
