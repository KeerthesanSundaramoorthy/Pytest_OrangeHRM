...
class TestImmigration:
    ...
    @pytest.mark.smoke
    @pytest.mark.parametrize("number, issued_date, expiry_date, status, review_date, comment", ExcelReader.get_data("C:\\Users\\SM\\Desktop\\Pytest_clone(6-6)\\Pytest_OrangeHRM\\Excel_Files\\ImmigrationData.xlsx", "immigration"))
