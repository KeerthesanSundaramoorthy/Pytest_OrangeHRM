...
class TestImmigration:
    ...
    @pytest.mark.smoke
    @pytest.mark.parametrize("number, issued_date, expiry_date, status, review_date, comment", Excel_Reader.get_data("E:\gitpytest_clone\Pytest_OrangeHRM\Excel_Files\ImmigrationData.xlsx", "immigration"))
