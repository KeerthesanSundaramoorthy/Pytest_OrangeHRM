...
class TestValidAddEmployee:
    @pytest.mark.parametrize("fname,mname,lname", excelreader.get_data("E:\Clone_pytest\Clone_pytest\Pytest_OrangeHRM\ExcelFiles\Invalid_Add_Employee.xlsx", "InvalidAddEmployee"))
